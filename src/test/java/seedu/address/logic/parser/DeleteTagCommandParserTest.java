...
public class DeleteTagCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", DeleteTagCommand.MESSAGE_NO_TAGS_REMOVED);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // empty tag
        assertParseFailure(parser, "1" + TAG_EMPTY, DeleteTagCommand.MESSAGE_NO_TAGS_REMOVED);
    }
    ...
    public void parse_oneTag_success() {
        ...
        expectedCommand = new DeleteTagCommand(targetIndex, List.of(new Tag(VALID_TAG_FRIEND)));
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleTags_success() {
        ...
        DeleteTagCommand expectedCommand = new DeleteTagCommand(
