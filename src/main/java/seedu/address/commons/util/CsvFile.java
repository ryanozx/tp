...
public class CsvFile {
    ...
    public class CsvRow implements GetValuer {
         ...
         * the first n columns, where n is the number of values in the row. The remaining columns
         * will be treated as empty values (empty string).
         * @param object Object that implements CsvParsable, which returns a list of string values
         *               when CsvParsable::getCsvValues() is called
         * @throws CsvMismatchedColumnException if the number of values in the row is greater
         *      than the number of columns in the file
         */
        public CsvRow(CsvParsable object) throws CsvMismatchedColumnException {
            requireNonNull(object);
            List<String> values = object.getCsvValues();
    ...
    /**
     * Adds a row of values generated by an object into the CSV file.
     * This is useful if adding a row from a serialised object.
     * @param object Object that implements CsvParsable, which is required
     *               to generated a row of string values for the CSV row
     */
    public void addRow(CsvParsable object) {
        CsvRow newRow = new CsvRow(object);
        rows.add(newRow);
    }
