...
abstract class AdaptedPerson {
    ...
    final List<AdaptedTag> tags = new ArrayList<>();

    /**
     * Initialises fields in the AdaptedPerson base class
     */
    public AdaptedPerson(String name, String phone, String email, String address, List<AdaptedTag> tags) {
        this.name = name;
        this.phone = phone;
        this.email = email;
