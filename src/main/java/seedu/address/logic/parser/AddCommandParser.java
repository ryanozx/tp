...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_PERSON_NAME, PREFIX_PERSON_PHONE,
                        PREFIX_PERSON_EMAIL, PREFIX_PERSON_ADDRESS, PREFIX_PERSON_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_PERSON_NAME, PREFIX_PERSON_ADDRESS,
                PREFIX_PERSON_PHONE, PREFIX_PERSON_EMAIL)
        ...
        Set<Tag> tagList = ParserUtil.parseTags(argMultimap.getAllValues(PREFIX_PERSON_TAG));
